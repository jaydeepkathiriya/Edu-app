    ...
    try {
      ...
      if (error) {
        if (error.message.includes('email')) {
          ...
          setErrors(prev => ({ ...prev, password: 'Authentication service is currently unavailable. Please try again later.' }));
        } else {
      ...
      setErrors(prev => ({ ...prev, password: 'Network error. Please check your connection and try again.' }));
    } finally {
      setIsLoading(false);
    }
  };
